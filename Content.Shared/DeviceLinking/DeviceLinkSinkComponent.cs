...
public sealed partial class DeviceLinkSinkComponent : Component
{
    ...
    /// </summary>
    [DataField("ports", customTypeSerializer: typeof(PrototypeIdHashSetSerializer<SinkPortPrototype>)), AutoNetworkedField]
    public HashSet<string>? Ports;

    /// <summary>
    /// Used for removing a sink from all linked sources when it gets removed
    /// </summary>
    [DataField("links"), AutoNetworkedField]
    ...
    /// </summary>
    [DataField("invokeCounter"), AutoNetworkedField]
